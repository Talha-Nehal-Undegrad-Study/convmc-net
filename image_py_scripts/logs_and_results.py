...
def get_modularized_record(project_name, q, db, new_entry, hyper_param_net, params_net, ROOT, SESSION, current_epoch = None):
    ...
    if current_epoch == None:
        ...
        model_path = (f'{dir}/{project_name}_Layers_{params_net["layers"]}_TrainInstances_{hyper_param_net["TrainInstances"]}_Epochs_[{current_epoch}_out_of_{hyper_param_net["Epochs"]}]_lr_{hyper_param_net["Lr"]}.pth')
        return model_path
